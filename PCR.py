...
inputColumns=78
data = pd.read_csv('C:\\Users\\Naveed\\Desktop\\testsample.csv')
X = data.iloc[:,7:inputColumns]  #independent columns
y = data.iloc[:,-1]
...
pcr.fit(X_train, y_train) # Scale your predictors for best results.
